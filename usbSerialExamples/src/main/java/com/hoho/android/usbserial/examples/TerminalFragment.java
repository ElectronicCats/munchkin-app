...
public class TerminalFragment extends Fragment implements SerialInputOutputManager.Listener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // Inicializar vista de recepción
        ...
        View btnLedOn = view.findViewById(R.id.btn_led_on);
        View btnLedOff = view.findViewById(R.id.btn_led_off);
        View btnReset = view.findViewById(R.id.btn_reset);

        btnLedOn.setOnClickListener(v -> send("help"));
        btnLedOff.setOnClickListener(v -> send("info"));
        btnReset.setOnClickListener(v -> send("reboot"));
    ...
    private void receive(byte[] data) {
        if (data.length > 0) {
            try {
                ...
                receiveText.append("[Error decoding data]\n");
            }
        }
    }
